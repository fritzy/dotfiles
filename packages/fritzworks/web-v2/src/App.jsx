...
export default function App() {
  ...
  const [omittedBranchPrefixes, setOmittedBranchPrefixes] = useState(() => {
    try { return localStorage.getItem(OMITTED_BRANCH_PREFIXES_STORAGE_KEY) ?? DEFAULT_OMITTED_BRANCH_PREFIXES; }
    catch { return DEFAULT_OMITTED_BRANCH_PREFIXES; }
  });
  ...
  useEffect(() => {
    try { localStorage.setItem(OMITTED_BRANCH_PREFIXES_STORAGE_KEY, omittedBranchPrefixes); }
    catch { /* optional persistence */ }
  }, [omittedBranchPrefixes]);
        ...
        >
          <TargetProvider value={currentTarget}>
            <ActiveSessionsSidebar
              ...
              omittedBranchPrefixes={omittedBranchPrefixes}
              onOmittedBranchPrefixesChange={setOmittedBranchPrefixes}
