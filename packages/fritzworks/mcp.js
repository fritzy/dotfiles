...
const server = new McpServer({ name: 'fritzworks', version: PACKAGE.version });

server.registerTool('fw_config', {
...
server.registerTool('fw_browser_refresh', {
...
server.registerTool('fw_daemons', {
...
server.registerTool('fw_list', {
  ...
  const service = await requestDaemonService(
    `/fw/all?status=${all ? 'all' : 'active_paused'}&perpage=100`,
    { daemon },
  );
...
server.registerTool('fw_panel_layout', {
...
server.registerTool('fw_panel_add', {
...
server.registerTool('fw_panel_update', {
...
server.registerTool('fw_panel_close', {
...
server.registerTool('fw_resource_add', {
...
server.registerTool('fw_resource_list', {
...
server.registerTool('fw_resource_read', {
...
server.registerTool('fw_resource_write', {
...
server.registerTool('fw_resource_open', {
...
server.registerTool('fw_resource_remove', {
...
server.registerTool('fw_scratch', {
...
server.registerTool('fw_close', {
  description: 'Close a workstream in one call — no skill, no manual git inspection needed. '
    ...
    + 'user confirms discarding. This tool replaces shelling out to `fw close`.',
  inputSchema: withDaemon({
    workstream: workstreamArg,
...
server.registerTool('fw_stack_set', {
...
server.registerTool('fw_stack_link', {
...
server.registerTool('fw_issue_list', {
...
server.registerTool('fw_issue_add', {
...
server.registerTool('fw_issue_remove', {
